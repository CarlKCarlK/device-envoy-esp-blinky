...
//!
//! Wiring:
//! SOS blinky for `esp32-s3-devkitc-1-v1.1-n16r8` (ESP32-S3).
//!
//! Setup:
//! - This board uses a built-in NeoPixel-style (WS2812) LED on GPIO38.
...
async fn inner_main(spawner: Spawner) -> Result<Infallible> {
    ...
    info!("SOS smart LED blinky (RMT) starting on GPIO38 (esp32-s3-devkitc-1-v1.1-n16r8)");
