...
//!
//! Wiring:
//! SOS blinky for `esp32-s3-devkitc-1-v1.0-n16r8` (ESP32-S3).
//!
//! Setup:
//! - This board uses a built-in NeoPixel-style (WS2812) LED on GPIO48.
...
async fn inner_main(spawner: Spawner) -> Result<Infallible> {
    ...
    info!("SOS smart LED blinky (RMT) starting on GPIO48 (esp32-s3-devkitc-1-v1.0-n16r8)");

    let sos_strip = SosStrip::new(p.GPIO48, rmt80.channel0, spawner)?;
